...
- (UIView *)pointContentView {
    if (_pointContentView == nil) {
        ...
        _pointContentView = [XHTools xh_getUIViewWithFrame:CGRectMake(point.x-80, point.y - 40, 80, 40) withBackgroundColor:nil];
        ...
        XHBorderRadius(self.infoLabel, 5, 0, [UIColor whiteColor]);
        //cicle
        ...
        XHBorderRadius(cicleView, 3.5, 1.5, [UIColor hexStringToColor:@"#FF5555"]);
        [_pointContentView addSubview:cicleView];
        
        //line
        self.lineView = [XHTools xh_getUIViewWithFrame:CGRectMake(point.x - 1.5, Top_Title_Height, 1.5, self.frame.size.height - Top_Title_Height - Bottom_Title_Height) withBackgroundColor:[UIColor hexStringToColor:@"#979797"]];;
